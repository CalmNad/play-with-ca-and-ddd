    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "profiles_roles_roles" (
                ...
                CONSTRAINT "PK_4df0e6db4d73095e0d275a9cc57" PRIMARY KEY ("profilesId", "rolesId")
            )
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_ff9b6a8793af3f4d509c7c7e5a" ON "profiles_roles_roles" ("profilesId")
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_2b7c25049b9ca9e7e3a9468662" ON "profiles_roles_roles" ("rolesId")
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_ff9b6a8793af3f4d509c7c7e5a4" FOREIGN KEY ("profilesId") REFERENCES "profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "profiles_roles_roles"
            ADD CONSTRAINT "FK_2b7c25049b9ca9e7e3a94686620" FOREIGN KEY ("rolesId") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
